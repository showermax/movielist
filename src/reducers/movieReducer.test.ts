...
// })
//
// test.skip('should be add newFilm', ()=>{
//     const newFilm = {
//         id: 'newId',
//         name: 'Spider-Man',
//         watched: false,
...
// })
//
// test.skip('should be delete film', ()=>{
//
//     let endState = movieReducer(startState, removeFilmsAC(startState['allFilms'][0].id, 1))
//
...
// })
//
// test.skip('should be change status', ()=>{
//
//     let endState = movieReducer(startState, changeStatusAC(startState['allFilms'][0].id, true,1, 'watchedFilms'))
//
//
